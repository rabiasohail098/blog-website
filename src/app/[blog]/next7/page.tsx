      ...
      <div className="px-3 md:px-8 py-8 rounded-lg">
        ...
        <div className="px-3 md:px-8 py-8 rounded-lg">
          ...
          <ul className="px-3 md:px-12">
            ...
            <li className="pb-2 list-disc text-md mx-3 md:mx-9">
              Allowed importing pages from custom folders instead of being limited to the <span className="bg-gray-200 p-1">pages</span> directory.
            </li>
          ...
          <ul className="px-3 md:px-12">
            <li className="pb-2 list-disc text-md mx-3 md:mx-9">
              ...
              <span className="bg-gray-200 p-1">[id].js</span>) came later in Next.js 9.
            </li>
          </ul>
          ...
          <ul className="px-3 md:px-12">
          <li className="pb-2 list-disc text-md mx-3 md:mx-9">Allowed <b>custom Webpack and Babel configurations</b> through <span className="bg-gray-200 p-1">next.config.js</span>, enabling developers to fine-tune their build process.
          </li>
        ...
        <h4 className="pb-4 px-3 md:px-12 list-decimal text-lg font-semibold text-left font-serif">5. Customizable <span className="bg-gray-200 p-1">Document</span> and <span className="bg-gray-200 p-1">App</span> Components</h4>
         <ul className="px-3 md:px-12">
         <li className="pb-2 list-disc text-md mx-3 md:mx-9">Enhanced customization of <span className="bg-gray-200 p-1">_document.js</span> and <span className="bg-gray-200 p-1">_app.js</span> for global layouts, meta tags, and shared data between pages.
         </li>
         <li className="pb-2 list-disc text-md mx-3 md:mx-9">Example: Adding a global layout in <span className="bg-gray-200 p-1">_app.js</span></li>
         ...
         <ul className="px-3 md:px-12">
            <li className="pb-2 list-disc text-md mx-3 md:mx-9">Improved the <span className="bg-gray-200 p-1">next export</span> feature for better compatibility with static hosting.</li>
...
<ul className="px-3 md:px-12">
<li className="pb-2 list-disc text-md mx-3 md:mx-9"><b>No File-based Routing for Dynamic Routes: </b>The <span className="bg-gray-200 p-1">[id].js</span> syntax for dynamic routing was introduced in Next.js 9.</li>
