...
const Page = () => {
  return (
    <div className='px-3 md:px-8 py-8 rounded-lg  '>
        <Image src="/images/6.jpg" alt="setup" width={200} height={200} className="w-full h-full md:w-full sm:w-[660px] md:h-[550px] sm:h[350px] rounded-lg border border-slate-300"/>
        <div className='px-3 md:px-8 py-8 rounded-lg'>
        ...
        <h4  className='pb-4 list-decimal text-lg font-semibold text-left font-serif'>1. Built-in Support for Custom <span className='bg-gray-200 p-1'>routes</span></h4>
        <li className='pb-2 list-disc text-md md:mx-9 mx-3'>Improved routing capabilities with enhancements to the <span className='bg-gray-200 p-1'>next.config.js</span> file.</li>
        ...
        <li className='pb-2 list-disc text-md md:mx-9 mx-3'>Simplified adding TypeScript to projects, making it easier to set up by manually adding <span className='bg-gray-200 p-1'>tsconfig.json</span> and type definitions.</li>
        <h4  className='pb-4 list-decimal text-lg font-semibold text-left font-serif'>3.  Enhanced Dynamic Imports</h4>
        <li className='pb-2 list-disc text-md md:mx-9 mx-3'>Continued improvements to <span className='bg-gray-200 p-1'>next/dynamic</span> for dynamically importing components.</li>
        ...
        <li className='pb-2 list-disc text-md md:mx-9 mx-3'>Example: Easily add middleware or API endpoints to a <span className='bg-gray-200 p-1'>Next.js</span> app using server.js.
        </li>
</ul>
...
<li className='pb-2 list-disc text-md md:mx-9 mx-3'>Dynamic routing with file-based conventions (e.g., <span className='bg-gray-200 p-1'>[id].js</span>) was not yet available (introduced in Next.js 9).
</li>
